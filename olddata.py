...
p = r'filt_1031ff1.csv'
with open(p, encoding='utf-8') as f:
    data1 = np.loadtxt(f,delimiter = ',')  

p = r'filt_1031ff2.csv'
with open(p, encoding='utf-8') as f:
    data2 = np.loadtxt(f,delimiter = ',')  

# p = r'sep_filt_1020test3.csv'
# with open(p, encoding='utf-8') as f:
#     data3 = np.loadtxt(f,delimiter = ',')  

# p = r'sep_filt_1020test4.csv'
# with open(p, encoding='utf-8') as f:
#     data4 = np.loadtxt(f,delimiter = ',')  

data = np.concatenate((data1[:, 64:128], data2[:, 64:128]), 0)
#data = np.concatenate((data1[:, 64:128], data2[:, 64:128], data3[:, 64:128], data4[:, 64:128],), 0)
#data = np.concatenate((data1[64:128, :], data2[64:128, :], data3[64:128, :], data4[64:128, :],), 1)
#emg_raw = data4[64:128, :].T
emg_raw = data
print(emg_raw.shape)
...
#np.save("Ica_W1234ext.npy", W)
#np.save("Ica_K1234ext.npy", K)
np.save("emg_mu_for_kmeans_1031ff2.npy", emg_mu_squared)
...
# save kmeans center
np.save("cluster_centers_1031ff2.npy", cluster_centers)
...
plotspikes(spike_trains,title='1031ff2')
...
dump(emg_FastICA, "emg_FastICA_1031ff2.joblib")
dump(_kmeans, "emg_kmeans_1031ff2.joblib")

np.savetxt("1031ff2.csv", spike_trains, delimiter=",")